...
namespace debuger
{
    public partial class Form1 : Form
    {
            ...
            switch (opcode_16)
            {
                case OP16_C0:
                    ...
                    switch (funct3_16)
                    {
                        ...
                        case FUNCT3_C0_FLD: return "illigal inst";
                        ...
                        case FUNCT3_C0_FSD: return "illigal inst";
                ...
                case OP16_C2:
                    ...
                    switch (funct3_16)
                    {
                        ...
                        case FUNCT3_C2_FLDSP: return "illigal inst";
                        ...
                        case FUNCT3_C2_FSDSP: return "illigal inst";
                ...
                default:
                    switch (opcode_32)
                    {
                        ...
                        case OP_LOAD_FP: return "illigal inst";
                        case OP_CUST_0: return "illigal inst";
                        case OP_MISC_MEM:
                            if (((insn >> 7) & 0x1f) == 0 && ((insn >> 15) & 0x1f) == 0 && ((insn >> 28) & 0xf) == 0)
                            {
                                ...
                                {
                                    if (((insn >> 20) & 0xff) == 0) return "fence.i";
                                    else return "illigal inst";
                                }
                                else return "illigal inst";
                            }
                        ...
                        case OP_STORE_FP: return "illigal inst";
                        case OP_CUST_1: return "illigal inst";
                        case OP_AMO:
                            rd_we = rd != 0;
                            mem_rd = true;
                            switch (funct5)
                        ...
                        case OP_MADD: return "illigal inst";
                        case OP_MSUB: return "illigal inst";
                        case OP_NMSUB: return "illigal inst";
                        case OP_NMADD: return "illigal inst";
                        case OP_OP_FP: return "illigal inst";
                        case OP_CUST_2: return "illigal inst";
                        case OP_BRANCH:
                            switch (funct3)
                            {
                                case FUNCT3_BEQ:
                        ...
                        case OP_CUST_3: return "illigal inst";
                        default: return "illigal inst";
                    }
            }
            return str;
        ...
        private string tracer_decode(int[] buff)
        {
            ...
            bool tran_en = (buff[7] >> 31) != 0;
            byte prv = (byte)((buff[7] >> 29) & 0x3);
            bool rv64 = ((buff[7] >> 28) & 1) != 0;
            Int64 time = (Int64) (buff[7] & 0x0fffffff);
            Int64 pc = ((Int64)buff[6] << 32) | (Int64)buff[5];
            Int32 insn = buff[4];
            ...
            mcause = csr_wdata = mem_addr = (((Int64)buff[3]) << 32) | (Int64)buff[2];
            mtval = mem_data = rd_data = (((Int64)buff[1]) << 32) | (Int64)buff[0];

            if (tran_en)
            {
                if (mcause < 0) str = string.Format("({0:d1} cycles) Interrupt {1:d}, epc = 0x{2:x8}, tval = 0x{3:x8}", time, mcause & 0x7fffffff, pc, mtval);
                else
                {
                    switch (mcause)
                    {
                    ...
                    str = string.Format("({0:d1} cycles) {1:}, epc = 0x{2:x8}, tval = 0x{3:x8}", time, str, pc, mtval);
                }
            }
            else
            {
                ...
                str = string.Format("({0:d1} cycles) [{1:}] {2:x16}:{3:} {4:}", time, prv == 0 ? "U" : prv == 1 ? "S" : prv == 3 ? "M" : "UNKNOWN", (UInt64)pc, tmp, str);
